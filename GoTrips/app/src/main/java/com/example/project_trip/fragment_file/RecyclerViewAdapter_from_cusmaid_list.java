...
public class RecyclerViewAdapter_from_cusmaid_list extends RecyclerView.Adapter<RecyclerViewAdapter_from_cusmaid_list.MyViewHolder> {
    ...
    public RecyclerViewAdapter_from_cusmaid_list(Context mContext1, List<Main_item_from_show_local> miData1) {
