...
public class Local_Guide_In_RecylerAdapter extends RecyclerView.Adapter<Local_Guide_In_RecylerAdapter.MyViewHolder> {
    ...
    public Local_Guide_In_RecylerAdapter(Context mContext1, List<Main_item_from_show_local> miData1) {
