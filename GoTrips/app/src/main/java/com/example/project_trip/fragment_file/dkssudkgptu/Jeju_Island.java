...
public class Jeju_Island extends AppCompatActivity {
    ...
    data = new ArrayList<>();
        data.add(new Detail_Region_Item("서귀포시"));
        data.add(new Detail_Region_Item("제주시"));
        data.add(new Detail_Region_Item("남제주군"));
        data.add(new Detail_Region_Item("북제주군"));
